      ...
      <div className="relative">
        ...
        <button
          ...
          className={`w-full bg-white text-left flex items-center justify-between transition-all ${variant === 'thick'
            ? 'border-[3px] border-indigo-100 text-brand-primary text-lg font-medium px-6 py-6 rounded-[20px] focus:outline-none focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10'
            : 'border-2 border-gray-200 text-gray-700 text-sm font-medium px-4 py-3 rounded-xl focus:outline-none focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20'
