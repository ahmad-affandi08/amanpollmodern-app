  ...
  if (hasDisposisi) {
    return (
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-[20px] p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-green-700">
              Aduan ini telah mendapat disposisi dari pimpinan.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[20px] shadow-lg p-5">
          ...
          <div className="space-y-3">
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 p-4 rounded-xl border border-purple-100">
              ...
              <p className="mt-1 font-bold text-gray-900">{aduan.no_inventaris}</p>
            </div>

            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-4 rounded-xl border border-blue-100">
              <small className="text-xs text-blue-600 font-semibold">Nama Alat</small>
              <p className="mt-1 font-bold text-gray-900">{aduan.nama_alat_nama}</p>
            </div>

            <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-4 rounded-xl border border-orange-100">
              <div className="flex items-center gap-2 mb-2">
                <FileText size={14} className="text-orange-600" />
                <small className="text-xs text-orange-600 font-semibold">Keluhan</small>
              </div>
              <p className="text-sm text-gray-900">{aduan.keluhan}</p>
            </div>
            ...
            {aduan.tindakan_teknisi && (
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-xl border border-green-100">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <small className="text-xs text-green-600 font-semibold">Tindakan Petugas</small>
                </div>
                <p className="text-sm text-gray-900">{aduan.tindakan_teknisi}</p>
              </div>
            )}
            ...
            {aduan.rekomendasi && (
              <div className="bg-gradient-to-br from-yellow-50 to-amber-50 p-4 rounded-xl border border-yellow-100">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <small className="text-xs text-yellow-600 font-semibold">Rekomendasi Petugas</small>
                </div>
                <p className="text-sm text-gray-900">{aduan.rekomendasi}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-white rounded-[20px] shadow-lg p-5">
          <DisposisiDetail disposisi={aduan} />
        </div>
