...
/**
 * Mobile Disposisi Aduan Page
 * Modern redesign matching app's design system
 */
export default function MobileDisposisiAduan() {
  const { id } = useParams();
  const { data: aduan, isLoading, error } = useAduanDetail(id);
      ...
      <div className="min-h-screen bg-brand-primary-soft flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-[20px] shadow-2xl p-6 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-2">Aduan Tidak Ditemukan</h3>
            <p className="text-sm text-gray-600 mb-6">
              Data aduan tidak dapat dimuat. Silakan coba lagi atau hubungi administrator.
            </p>
            <button
